...
//	}
	...
	By link_highlights = By.xpath("//div[@class='link' and contains(text(),'Highlight')]");
	...
	By link_compare = By.xpath("//div[contains(@class, 'link') and text()=' Compare ']");
...
//	By orderID = By.xpath("//div[text()=' Reference number ']/../div[2]/div[1]");
	...
	//Ronnie Script
	By link_Deals = By.xpath("//form[contains(@class,'menu-bar-height')] //a[text()='Deals']");
