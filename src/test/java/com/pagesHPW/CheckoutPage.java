...
public class CheckoutPage extends BasePage {
	...
	By txt_gCashChckout = By.xpath("(//div[@class='gcash-checkout']/p)[1]");
	By txt_gCashChckout2 = By.xpath("(//div[@class='gcash-checkout']/p)[2]");
	...
	public boolean isElementExist(String message, String element, int waitTime) {
		...
		case "otpText":
			...
			break;
		case "hdrCheckout":
			flag = ElementVisibility(hdrCheckout, waitTime);
			break;
